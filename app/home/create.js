...
const create = () => {
    ...
    async function addHabit() {
        try {
            ...
            console.log("error adding the habit", error)
        }
    }
    ...
    return (
        <View style={{ padding: 10 }}>
            <Ionicons name="arrow-back" onPress={goBack} size={24} color="black" />
            <Text style={{ fontSize: 20, marginTop: 10 }}>
                Create <Text style={{ fontSize: 20, fontWeight: "500" }}>Habit</Text>
            </Text>
            <TextInput value={title} onChangeText={(text) => setTitle(text)} style={{ width: "95%", marginTop: 15, padding: 15, borderRadius: 10, backgroundColor: "#E1EBEE" }} placeholder='Title' />
